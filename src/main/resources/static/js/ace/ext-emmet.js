...
}), ace.define("ace/ext/emmet", ["require", "exports", "module", "ace/keyboard/hash_handler", "ace/editor", "ace/snippets", "ace/range", "resources", "resources", "range", "tabStops", "resources", "utils", "actions", "ace/config"], function (e, t, n)
{
    "use strict";
    function a()
    {
    ...
    t.commands = new r, t.runEmmetCommand = function (e)
    {
        ...
        {
            e._signal("changeStatus", typeof r == "string" ? r : r.message), console.log(r), n = !1
        }
        return n
    };
    ...
    t.AceEmmetEditor = a, e("ace/config").defineOptions(i.prototype, "editor", {
        enableEmmet: {
            set: function (e)
            {
