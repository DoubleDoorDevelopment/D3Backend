...
}), ace.define("ace/mode/sass_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/scss_highlight_rules"], function (e, t, n)
{
    ...
    var r = e("../lib/oop"), i = e("../lib/lang"), s = e("./scss_highlight_rules").ScssHighlightRules, o = function ()
    {
        ...
        }, {token: "error.invalid", regex: "/\\*|[{;}]"}, {token: "support.type", regex: /^\s*:[\w\-]+\s/}), this.$rules.comment = [
            {
...
{
    "use strict";
    var r = e("../lib/oop"), i = e("./text").Mode, s = e("./sass_highlight_rules").SassHighlightRules, o = e("./folding/coffee").FoldMode, u = function ()
    {
