    ...
    u.inherits(a, o), function ()
    {
        ...
        }, this.toggleCommentLines = function (e, t, n, r)
        {
            ...
            for (var o = n; o <= r; ++o)
            {
                ...
                commentLine.test(u) ? u = u.replace(commentLine, "$1") : u = u.replace(indentation, "$&#"), i.end.row = i.start.row = o, i.end.column = u.length + 1, t.replace(i, u)
            }
