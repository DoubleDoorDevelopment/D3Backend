    ...
    }, t.Rewriter = function ()
    {
        ...
        }, e.prototype.addImplicitBracesAndParens = function ()
        {
            ...
            return e = [], this.scanTokens(function (t, n, r)
            {
                ...
                {
                    var s;
                    i == null && (i = !0), s = t != null ? t : n, e.push(["{", s, {sameLine: !0, startsLine: i, ours: !0}]), r.splice(s, 0, m("{", m(String("{"))));
                    if (t == null)return n += 1
                }, d = function (t)
                {
        ...
        }, e.prototype.addLocationDataToGeneratedTokens = function ()
        {
            ...
            {
                var r, i, s, o, u, a;
                return e[2] ? 1 : !e.generated && !e.explicit ? 1 : (e[0] === "{" && (s = (u = n[t + 1]) != null ? u[2] : void 0) ? (i = s.first_line, r = s.first_column) : (o = (a = n[t - 1]) != null ? a[2] : void 0) ? (i = o.last_line, r = o.last_column) : i = r = 0, e[2] = {
                    first_line: i,
                    first_column: r,
                    last_line: i,
                    last_column: r
...
}), ace.define("ace/mode/coffee/lexer", ["require", "exports", "module", "ace/mode/coffee/rewriter", "ace/mode/coffee/helpers"], function (e, t, n)
{
    ...
    et = e("./rewriter"), F = et.Rewriter, w = et.INVERSES, tt = e("./helpers"), V = tt.count, Y = tt.starts, X = tt.compact, K = tt.last, G = tt.repeat, $ = tt.invertLiterate, Q = tt.locationDataToString, Z = tt.throwSyntaxError, t.Lexer = k = function ()
    {
        ...
        }, e.prototype.identifierToken = function ()
        {
            ...
            return (o = y.exec(this.chunk)) ? (s = o[0], r = o[1], e = o[2], i = r.length, l = void 0, r === "own" && this.tag() === "FOR" ? (this.token("OWN", r), r.length) : (n = e || (c = K(this.tokens)) && ((d = c[0]) === "." || d === "?." || d === "::" || d === "?::" || !c.spaced && c[0] === "@"), h = "IDENTIFIER", !n && (nt.call(x, r) >= 0 || nt.call(f, r) >= 0) && (h = r.toUpperCase(), h === "WHEN" && (v = this.tag(), nt.call(T, v) >= 0) ? h = "LEADING_WHEN" : h === "FOR" ? this.seenFor = !0 : h === "UNLESS" ? h = "IF" : nt.call(z, h) >= 0 ? h = "UNARY" : nt.call(B, h) >= 0 && (h !== "INSTANCEOF" && this.seenFor ? (h = "FOR" + h, this.seenFor = !1) : (h = "RELATION", this.value() === "!" && (l = this.tokens.pop(), r = "!" + r)))), nt.call(S, r) >= 0 && (n ? (h = "IDENTIFIER", r = String(r), r.reserved = !0) : nt.call(j, r) >= 0 && this.error('reserved word "' + r + '"')), n || (nt.call(u, r) >= 0 && (r = a[r]), h = function ()
            {
                switch (r)
                {
                    case"!":
        ...
        }, e.prototype.stringToken = function ()
        {
            ...
            return n ? (r = this.removeNewlines(n.slice(1, -1)), t === '"' && 0 < n.indexOf("#{", 1) ? this.interpolateString(r, {
                strOffset: 1,
                lexedLength: n.length
            }) : this.token("STRING", t + this.escapeLines(r) + t, 0, n.length), (e = /^(?:\\.|[^\\])*\\(?:0[0-7]|[1-7])/.test(n)) && this.error("octal escape sequences " + n + " are not allowed"), n.length) : 0
        }, e.prototype.heredocToken = function ()
        {
            var e, t, n, r;
            return (n = p.exec(this.chunk)) ? (t = n[0], r = t.charAt(0), e = this.sanitizeHeredoc(n[2], {quote: r, indent: null}), r === '"' && 0 <= e.indexOf("#{") ? this.interpolateString(e, {
                heredoc: !0,
                strOffset: 3,
        ...
        }, e.prototype.lineToken = function ()
        {
            ...
            {
                i < this.baseIndent ? this.error("missing indentation", t.length) : (this.indebt = 0, this.outdentToken(this.indent - i, r, t.length));
            }
        ...
        }, e.prototype.literalToken = function ()
        {
            ...
            else if (nt.call(L, r) >= 0)
            {
                n = "MATH";
            }
            else if (nt.call(c, r) >= 0)
            {
                n = "COMPARE";
            }
            else if (nt.call(h, r) >= 0)
            {
                n = "COMPOUND_ASSIGN";
            }
            else if (nt.call(z, r) >= 0)
            {
                n = "UNARY";
            }
            else if (nt.call(I, r) >= 0)
            {
                n = "SHIFT";
            }
            else if (nt.call(C, r) >= 0 || r === "?" && (t != null ? t.spaced : void 0))
            {
                n = "LOGIC";
            }
            else if (t && !t.spaced)
            {
                if (r === "(" && (a = t[0], nt.call(s, a) >= 0))
                {
        ...
        }, e.prototype.interpolateString = function (t, n)
        {
            ...
            for (o = C = 0, k = T.length; C < k; o = ++C)
            {
                x = T[o], S = x[0], N = x[1], o && (o && (g = this.token("+", "+")), p = S === "TOKENS" ? N[0] : x, g[2] = {
                    first_line: p[2].first_line,
                    first_column: p[2].first_column,
                    last_line: p[2].first_line,
                    last_column: p[2].first_column
                }), S === "TOKENS" ? (O = this.tokens).push.apply(O, N) : S === "NEOSTRING" ? (x[0] = "STRING", x[1] = this.makeString(N, '"', s), this.tokens.push(x)) : this.error("Unexpected " + S);
            }
    ...
    }(), x = ["true", "false", "null", "this", "new", "delete", "typeof", "in", "instanceof", "return", "throw", "break", "continue", "debugger", "if", "else", "switch", "for", "while", "do", "try", "catch", "finally", "class", "extends", "super"], f = ["undefined", "then", "unless", "until", "loop", "of", "by", "when"], a = {
        and: "&&",
        or: "||",
        is: "==",
        isnt: "!=",
        ...
        performAction: function (t, n, r, i, s, o, u)
        {
            ...
            switch (s)
            {
                ...
                case 177:
                    ...
                    break;
                case 178:
                    this.$ = i.addLocationDataFn(u[a - 2], u[a])([
                        [o[a - 1], o[a]]
                    ]);
                    break;
                case 179:
                    this.$ = i.addLocationDataFn(u[a - 3], u[a])([
                        [o[a - 2], o[a - 1]]
                    ]);
                    break;
                case 180:
        ...
        parse: function (t)
        {
            ...
            for (; ;)
            {
                ...
                if (typeof w == "undefined" || !w.length || !w[0])
                {
                    ...
                    this.lexer.showPosition ? L = "Expecting " + k.join(", ") + ", got '" + (this.terminals_[g] || g) + "'" : L = "Unexpected " + (g == h ? "end of input" : "'" + (this.terminals_[g] || g) + "'"), this.lexer.yylloc.first_line !== p.first_line && (p = this.lexer.yylloc), this.parseError(L, {
...
}), ace.define("ace/mode/coffee/nodes", ["require", "exports", "module", "ace/mode/coffee/scope", "ace/mode/coffee/lexer", "ace/mode/coffee/helpers"], function (e, t, n)
{
    ...
    }(o), t.Call = a = function (e)
    {
        ...
        }, t.prototype.unfoldSoak = function (e)
        {
            ...
            if (this.soak)
            {
                ...
                {
                    i = new O(this.superReference(e)), o = new Z(i);
                }
    ...
    }(o), t.Op = B = function (e)
    {
        ...
        var t, n;
        return Tt(r, e), t = {"==": "===", "!=": "!==", of: "in"}, n = {"!==": "===", "===": "!=="}, r.prototype.children = ["first", "second"], r.prototype.isSimpleNumber = D, r.prototype.isUnary = function ()
        {
            return !this.second
