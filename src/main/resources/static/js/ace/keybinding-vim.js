...
}), ace.define("ace/keyboard/vim/maps/util", ["require", "exports", "module", "ace/keyboard/vim/registers", "ace/lib/dom"], function (e, t, n)
{
    ...
    i.importCssString(".insert-mode .ace_cursor{    border-left: 2px solid #333333;}.ace_dark.insert-mode .ace_cursor{    border-left: 2px solid #eeeeee;}.normal-mode .ace_cursor{    border: 0!important;    background-color: red;    opacity: 0.5;}", "vimMode"), n.exports = {
        onVisualMode: !1, onVisualLineMode: !1, currentMode: "normal", noMode: function (e)
        {
        ...
        }, normalMode: function (e)
        {
            ...
            var t;
            return e.getOverwrite() || (t = e.getCursorPosition(), t.column > 0 && e.navigateLeft()), e.setOverwrite(!0), e.keyBinding.$data.buffer = "", e.keyBinding.$data.vimState = "start", this.onVisualMode = !1, this.onVisualLineMode = !1, e._emit("changeStatus"), e.commands.recording ? (e.commands.toggleRecording(e), e.commands.macro) : []
...
}), ace.define("ace/keyboard/vim/maps/motions", ["require", "exports", "module", "ace/keyboard/vim/maps/util", "ace/search", "ace/range"], function (e, t, n)
{
    ...
    n.exports = {
        w: new s(function (e)
        {
            ...
            if (t.ch && u.test(t.ch))
            {
                while (t.ch && u.test(t.ch))t.next();
            }
            else
            {
                while (t.ch && !o.test(t.ch))t.next();
            }
        ...
        }), b: new s(function (e)
        {
            ...
            if (t.ch && u.test(t.ch))
            {
                while (t.ch && u.test(t.ch))t.prev();
            }
            else
            {
                while (t.ch && !o.test(t.ch))t.prev();
            }
        ...
        }), E: new s(function (e)
        {
            ...
            param: !0, handlesCount: !0, getPos: function (e, t, n, i, s, o)
            {
                i == "space" && (i = " "), o || (d = {ch: "f", param: i});
            ...
            param: !0, handlesCount: !0, getPos: function (e, t, n, i, s, o)
            {
                i == "space" && (i = " "), o || (d = {ch: "t", param: i});
                var u = e.getCursorPosition(), a = r.getRightNthChar(e, u, i, n || 1);
                o && a == 0 && !(n > 1) && (a = r.getRightNthChar(e, u, i, 2));
            ...
            param: !0, handlesCount: !0, getPos: function (e, t, n, i, s, o)
            {
                i == "space" && (i = " "), o || (d = {ch: "T", param: i});
                var u = e.getCursorPosition(), a = r.getLeftNthChar(e, u, i, n || 1);
                o && a === 0 && !(n > 1) && (a = r.getLeftNthChar(e, u, i, 2));
                if (typeof a == "number")return u.column -= a, u
            }
        }), ";": new s({
            handlesCount: !0, getPos: function (e, t, r, i, s)
            {
                var o = d.ch;
                if (!o)return;
        ...
        }), "}": new s(function (e)
        {
            ...
            param: !0, handlesCount: !0, getPos: function (e, t, n, r, i)
            {
...
{
    "use strict";
    var r = e("./util"), i = e("../registers"), s = e("../../../range").Range;
    n.exports = {
        d: {
            selFn: function (e, t, n, s)
            {
            ...
            }, fn: function (e, t, n, i)
            {
                ...
                switch (i)
                {
                    case"c":
                        ...
                        var o = e.$getSelectedRows();
                        t = new s(o.first, 0, o.last, Infinity), e.session.remove(t), e.$blockScrolling--, r.insertMode(e);
                        break;
                    default:
...
{
    n.exports = {
        x: {operator: {ch: "d", count: 1}, motion: {ch: "l", count: 1}},
        X: {operator: {ch: "d", count: 1}, motion: {ch: "h", count: 1}},
        D: {operator: {ch: "d", count: 1}, motion: {ch: "$", count: 1}},
        C: {operator: {ch: "c", count: 1}, motion: {ch: "$", count: 1}},
        s: {operator: {ch: "c", count: 1}, motion: {ch: "l", count: 1}},
        S: {operator: {ch: "c", count: 1}, param: "c"}
    }
}), ace.define("ace/keyboard/vim/commands", ["require", "exports", "module", "ace/lib/lang", "ace/keyboard/vim/maps/util", "ace/keyboard/vim/maps/motions", "ace/keyboard/vim/maps/operators", "ace/keyboard/vim/maps/aliases", "ace/keyboard/vim/registers"], function (e, t, n)
{
    ...
    }, v = function (e)
    {
        ...
        z: {
            ...
            fn: function (e, t, n)
            {
                d(function ()
                {
                    ...
                    r != n ? e.session.replace(t, r) : n.toLowerCase() != n ? e.session.replace(t, n.toLowerCase()) : e.navigateRight()
                }, n || 1)
            }
        }, "*": {
            fn: function (e, t, n, r)
            ...
            fn: function (e, t, n, r)
            {
                ...
                i.backwards = !1, i.start = null, e.selection.moveCursorRight(), e.selection.clearSelection(), e.findNext(i), v(e);
            ...
            {
                var i = e.getLastSearchOptions();
                i.backwards = !0, i.start = null, e.findPrevious(i), v(e);
                var s = e.selection.getRange();
                s.end.row = s.start.row, s.end.column = s.start.column, e.selection.setSelectionRange(s, !0)
            }
        }, v: {
            ...
            fn: function (e, t, n, i)
            {
                ...
                {
                    e.navigateRight(), e.insert(r.stringRepeat(s.text, n || 1)), e.navigateLeft();
                }
            ...
            fn: function (e, t, n, i)
            {
                ...
                {
                    e.insert(r.stringRepeat(s.text, n || 1));
                }
                e.setOverwrite(!0), e.selection.clearSelection()
            }
        }, J: {
        ...
        accepting: [f, l, c, h], currentCmd: null, currentCount: "", pendingCount: "", status: "", operator: null, motion: null, lastInsertCommands: [], push: function (e, t, n)
        {
            ...
            else if (t === "0" && !this.currentCount.length || !/^\d+$/.test(t) || !this.isAccepting(f))
            {
                if (!this.operator && this.isAccepting(l) && o[t])
                {
                    this.operator = {
                        ch: t,
                        count: this.getCount()
                    }, this.currentCmd = l, this.accepting = [f, c, h], this.exec(e, {operator: this.operator});
                }
                else if (s[t] && this.isAccepting(c))
                {
                    this.currentCmd = c;
                    var p = {operator: this.operator, motion: {ch: t, count: this.getCount()}};
                    s[t].param ? this.waitForParam(p) : this.exec(e, p)
                }
                else if (u[t] && this.isAccepting(c))
                {
                    u[t].operator.count = this.getCount(), this.exec(e, u[t]);
                }
                else if (m[t] && this.isAccepting(h))
                {
                ...
                {
                    this.operator ? (this.operator.count = this.getCount(), this.exec(e, {operator: this.operator}, t)) : (i = t.length == 1, this.reset());
                }
            }
            else
            {
                this.currentCount += t, this.currentCmd = f, this.accepting = [f, l, c, h];
            }
        ...
        {
            var e = this.currentCount || this.pendingCount;
            return this.currentCount = "", this.pendingCount = e, e && parseInt(e, 10)
        }, exec: function (e, t, n)
        {
            ...
            if (!r && !a && u && n)
            {
                o[u.ch].fn(e, null, u.count, n), this.reset();
            }
            else if (r)
            {
                var f = function (t)
            ...
            {
                a && (a.fn(e, e.getSelectionRange(), a.count, n), this.reset());
            }
            b(e)
...
{
    "use strict";
    var r = e("./vim/commands"), i = r.coreCommands, s = e("./vim/maps/util"), o = e("../lib/useragent"), u = {
        i: {command: i.start},
        I: {command: i.startBeginning},
        a: {command: i.append},
        A: {command: i.appendEnd},
        "ctrl-f": {command: "gotopagedown"},
        "ctrl-b": {command: "gotopageup"}
    };
    t.handler = {
        $id: "ace/keyboard/vim", handleMacRepeat: function (e, t, n)
        {
            if (t == -1)
            {
        ...
        }, updateMacCompositionHandlers: function (e, t)
        {
            var n = function (e)
            {
                ...
                {
                    this.onCompositionUpdateOrig(e)
                }
            }, r = function (e)
            {
        ...
        }, handleKeyboard: function (e, t, n, s, a)
        {
            ...
            var f = e.editor, l = e.vimState || "start";
            t == 1 && (n = "ctrl-" + n);
            if (n == "ctrl-c")
            {
                return !o.isMac && f.getCopyText() ? (f.once("copy", function ()
                {
            ...
            if (l == "start")
            {
                ...
                if (t == -1 || t == 1 || t === 0 && n.length > 1)
                {
                    ...
                    var c = r.inputBuffer.push(f, n);
                    if (!c && t !== -1)return;
                    return {command: "null", passEvent: !c}
                }
                if (n == "esc" && t === 0)return {command: i.stop};
                if (t === 0 || t == 4)return {command: "null", passEvent: !0}
            }
