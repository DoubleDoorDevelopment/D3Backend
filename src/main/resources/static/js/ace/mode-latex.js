ace.define("ace/mode/latex_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    var r = e("../lib/oop"), i = e("./text_highlight_rules").TextHighlightRules, s = function () {
        this.$rules = {start: [
            ...
            {token: ["keyword", "lparen", "variable.parameter", "rparen"], regex: "(\\\\label)(?:({)([^}]*)(}))?"},
    ...
    r.inherits(u, i), function () {
        this.foldingStartMarker = /^\s*\\(begin)|(section|subsection|paragraph)\b|{\s*$/, this.foldingStopMarker = /^\s*\\(end)\b|^\s*}/, this.getFoldWidgetRange = function (e, t, n) {
            ...
            var r = ["\\subsection", "\\section", "\\begin", "\\end", "\\paragraph"], i = new o(e, t, n), u = i.getCurrentToken();
...
}), ace.define("ace/mode/latex", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/latex_highlight_rules", "ace/mode/folding/latex", "ace/range"], function (e, t, n) {
    "use strict";
    var r = e("../lib/oop"), i = e("./text").Mode, s = e("./latex_highlight_rules").LatexHighlightRules, o = e("./folding/latex").FoldMode, u = e("../range").Range, a = function () {
