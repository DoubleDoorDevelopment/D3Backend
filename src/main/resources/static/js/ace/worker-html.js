    ...
    n.exports = function r(t, n, i) {
        ...
        u.prototype._parseError = function (e, t) {
            ...
            function n(e) {
                ...
                if (n === "&")t.setState(a); else if (n === "<")t.setState(j); else if (n === "\0")t._emitToken({type: "Characters", data: n}), e.commit(); else {
            ...
            function f(e) {
                var n = e.char();
                if (n === r.EOF)return t._emitToken({type: "EOF", data: null}), !1;
                if (n === "&")t.setState(l); else if (n === "<")t.setState(d); else if (n === "\0")t._parseError("invalid-codepoint"), t._emitToken({type: "Characters", data: "\ufffd"}), e.commit(); else {
                    var i = e.matchUntil("&|<|\0");
                    t._emitToken({type: "Characters", data: n + i}), e.commit()
                }
                return!0
            ...
            function c(e) {
                var n = e.char();
                if (n === r.EOF)return t._emitToken({type: "EOF", data: null}), !1;
                if (n === "<")t.setState(g); else if (n === "\0")t._parseError("invalid-codepoint"), t._emitToken({type: "Characters", data: "\ufffd"}), e.commit(); else {
                    var i = e.matchUntil("<|\0");
            ...
            function h(e) {
                var n = e.char();
                if (n === r.EOF)return t._emitToken({type: "EOF", data: null}), !1;
                if (n === "\0")t._parseError("invalid-codepoint"), t._emitToken({type: "Characters", data: "\ufffd"}), e.commit(); else {
                    var i = e.matchUntil("\0");
                    t._emitToken({type: "Characters", data: n + i})
                }
                return!0
            ...
            function p(e) {
                var n = e.char();
                if (n === r.EOF)return t._emitToken({type: "EOF", data: null}), !1;
                if (n === "<")t.setState(w); else if (n === "\0")t._parseError("invalid-codepoint"), t._emitToken({type: "Characters", data: "\ufffd"}), e.commit(); else {
                    var i = e.matchUntil("<|\0");
                    t._emitToken({type: "Characters", data: n + i})
                }
                return!0
            ...
            function N(e) {
                var i = e.char();
                if (i === r.EOF)e.unget(i), t.setState(n); else if (i === "-")t._emitToken({type: "Characters", data: "-"}), t.setState(C); else if (i === "<")t.setState(L); else if (i === "\0")t._parseError("invalid-codepoint"), t._emitToken({type: "Characters", data: "\ufffd"}), e.commit(); else {
            ...
            function R(e) {
                ...
                if (u) {
                    ...
                    for (var c = f.length - 2; c >= 0; c--)if (l.nodeName === f[c].nodeName) {
            ...
            function G(e) {
                var n = e.shift(2);
                if (n === "--")t._currentToken = {type: "Comment", data: ""}, t.setState(Z); else {
                    var i = e.shift(5);
        ...
        function g() {
            ...
            t.base = {end_tag_handlers: {"-default": "endTagOther"}, start_tag_handlers: {"-default": "startTagOther"}, processEOF: function () {
