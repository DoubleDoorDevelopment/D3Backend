ace.define("ace/mode/doc_comment_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    "use strict";
    var r = e("../lib/oop"), i = e("./text").Mode, s = e("./lua_highlight_rules").LuaHighlightRules, o = e("./folding/lua").FoldMode, u = e("../range").Range, a = e("../worker/worker_client").WorkerClient, f = function () {
    ...
    r.inherits(f, i), function () {
        ...
        this.getNextLineIndent = function (e, t, r) {
            ...
            var i = t.getLine(r - 1), s = this.$getIndent(i).length, o = this.getTokenizer().getLineTokens(i, "start").tokens, a = t.getTabString().length, f = s + a * n(o), l = this.$getIndent(t.getLine(r)).length;
            if (l < f)return;
    ...
    "use strict";
    var r = e("../lib/oop"), i = e("./html").Mode, s = e("./lua").Mode, o = e("./luapage_highlight_rules").LuaPageHighlightRules, u = function () {
