ace.define("ace/mode/doc_comment_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    "use strict";
    var r = e("../lib/oop"), i = e("./html").Mode, s = e("./handlebars_highlight_rules").HandlebarsHighlightRules, o = e("./behaviour/html").HtmlBehaviour, u = e("./folding/html").FoldMode, a = function () {
        i.call(this), this.HighlightRules = s, this.$behaviour = new o, this.foldingRules = new u
    };
