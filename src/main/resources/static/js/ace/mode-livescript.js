...
}), ace.define("ace/mode/livescript", ["require", "exports", "module", "ace/tokenizer", "ace/mode/matching_brace_outdent", "ace/range", "ace/mode/text"], function (e, t, n)
{
    ...
    r = "(?![\\d\\s])[$\\w\\xAA-\\uFFDC](?:(?!\\s)[$\\w\\xAA-\\uFFDC]|-[A-Za-z])*", t.Mode = i = function (t)
    {
    ...
    }(e("../mode/text").Mode), s = "(?![$\\w]|-[A-Za-z]|\\s*:(?![:=]))", o = {token: "string", regex: ".+"}, i.Rules = {
        start: [
            {
                token: "keyword",
        ...
        heregex: [
            ...
            {token: "string.regex", regex: "\\s*#{"}, {token: "comment.regex", regex: "\\s+(?:#.*)?"}, {token: "string.regex", regex: "\\S+"}],
        key: [{token: "keyword.operator", regex: "[.?@!]+"}, {token: "identifier", regex: r, next: "start"}, {token: "text", regex: ".", next: "start"}],
        comment: [{token: "comment.doc", regex: ".*?\\*/", next: "start"}, {token: "comment.doc", regex: ".+"}],
