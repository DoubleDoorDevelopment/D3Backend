    ...
    (function (e, n, r) {
        ...
        function I() {
            ...
            while (C < r) {
                s = t.charCodeAt(C++);
                if (e === s)break;
                if (92 === s)i += t.slice(n, C - 1) + W(), n = C; else if (C >= r || G(s))i += t.slice(n, C - 1), x({}, d.unfinishedString, i + String.fromCharCode(s))
            }
        ...
        function Ft() {
            ...
            for (; ;) {
                bt();
                if (l === k.type && J("["))t = qt(), K("]"), K("="), n = qt(), e.push(m(v.tableKey(t, n))); else if (a === k.type)t = qt(), J("=") ? (n = qt(), e.push(m(v.tableKeyString(t, n)))) : e.push(m(v.tableValue(t))); else {
                    if (null == (n = It())) {
                        vt.pop();
                        break
                    }
        ...
        function zt() {
            var e, t, r, i;
            mt && (r = gt());
            if (a === k.type)t = k.value, e = Ht(), n.scope && pt(e, i = dt(t)); else {
                if (!J("("))return null;
                e = qt(), K(")"), n.scope && (i = e.isLocal)
            }
            var s, u;
            for (; ;)if (l === k.type)switch (k.value) {
                case"[":
        ...
        function Vt(s, o) {
            return"undefined" == typeof o && "object" == typeof s && (o = s, s = undefined), o || (o = {}), t = s || "", n = S(i, o), C = 0, _ = 1, D = 0, r = t.length, ot = [
                []
            ], ut = 0, at = [], vt = [], n.comments && (O = []), n.wait ? e : Jt()
        }
        ...
        var d = e.errors = {unexpected: "Unexpected %1 '%2' near '%3'", expected: "'%1' expected near '%2'", expectedToken: "%1 expected near '%2'", unfinishedString: "unfinished string near '%1'", malformedNumber: "malformed number near '%1'"}, v = e.ast = {labelStatement: function (e) {
