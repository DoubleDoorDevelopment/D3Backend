...
}(this, function ()
{
    ...
    }([function (e, t, i)
    {
        ...
        n = [i(1), i(2), i(3)], o = function (e, t, i)
        {
            ...
            }, n.prototype.setMode = function (e)
            {
                ...
                {
                    var d = "text" == a.data;
                    if (o = this.getName(), t = this[d ? "getText" : "get"](), this._delete(), i.clear(this), i.extend(this, a.mixin), this.create(s, r), this.setName(o), this[d ? "setText" : "set"](t), "function" == typeof a.load)
                    {
                        try
                        {
                            a.load.call(this)
            ...
            }, n.registerMode = function (e)
            {
                ...
                if (i.isArray(e))
                {
                    for (t = 0; t < e.length; t++)n.registerMode(e[t]);
                }
                else
                {
    ...
    }, function (e, t, i)
    {
        ...
        n = [i(4), i(5), i(6), i(7), i(8), i(3)], o = function (e, t, i, n, o, s)
        {
            ...
            {
                if (t && (s.log('Warning: second parameter "name" is deprecated. Use setName(name) instead.'), this.options.name = t), e instanceof Function || void 0 === e)
                {
                    this.clear();
                }
                else
            ...
            {
                if (this.history && this.history.add(e, t), this.options.change)
                {
                    try
                    {
                        this.options.change()
            ...
            }, r._onKeyDown = function (e)
            {
                    ...
                    }, 0), this.searchBox)
                {
                    if (i && 70 == t)
                    {
                        this.searchBox.dom.search.focus(), this.searchBox.dom.search.select(), o = !0;
                    }
        ...
        n = [i(9), i(10), i(3)], o = function (e, t, i)
        {
            ...
            n.prototype._updateEditability = function ()
            {
                if (this.editable = {
                        field: !0,
                        value: !0
                    }, this.editor && (this.editable.field = "tree" === this.editor.options.mode, this.editable.value = "view" !== this.editor.options.mode, "tree" === this.editor.options.mode && "function" == typeof this.editor.options.editable))
                {
            ...
            }, n.prototype.setValue = function (e, t)
            {
                ...
                {
                    this.childs = void 0, this.value = e
                }
            ...
            }, n.prototype.insertBefore = function (e, t)
            {
                if (this._hasChilds())
                {
                    if (t == this.append)
                    {
                        e.setParent(this), e.fieldEditable = "object" == this.type, this.childs.push(e);
                    }
                    else
                    {
            ...
            {
                if (this.dom.value && "array" != this.type && "object" != this.type && (this.valueInnerText = i.getInnerText(this.dom.value)), void 0 != this.valueInnerText)
                {
                    try
                    {
                        var t;
            ...
            }, n.prototype._updateDomValue = function ()
            {
                ...
                if (e)
                {
                    ...
                    {
                        "string" == n && i.isUrl(t) ? this.editable.value && (e.title = "Ctrl+Click or Ctrl+Enter to open url in new window") : e.title = "";
                    }
            ...
            {
                if (this.dom.field && this.fieldEditable && (this.fieldInnerText = i.getInnerText(this.dom.field)), void 0 != this.fieldInnerText)
                {
                    try
                    {
            ...
            }, n.prototype._onDrag = function (e)
            {
                ...
                if (t = this.dom.tr, u = i.getAbsoluteTop(t), m = t.offsetHeight, u > y)
                {
                    s = t;
                    do {
                        s = s.previousSibling, l = n.getNodeFromTarget(s), p = s ? i.getAbsoluteTop(s) : 0;
                    }
                    while (s && p > y);
                ...
                else if (d = this.expanded && this.append ? this.append.getDom() : this.dom.tr, a = d ? d.nextSibling : void 0)
                {
                    ...
                    do {
                        c = n.getNodeFromTarget(r), r && (v = r.nextSibling ? i.getAbsoluteTop(r.nextSibling) : 0, g = r ? v - f : 0, 1 == c.parent.childs.length && c.parent.childs[0] == this && (u += 23)), r = r.nextSibling;
                    }
                    while (r && y > u + g);
                    if (c && c.parent)
                    {
                        ...
                        {
                            if (l = n.getNodeFromTarget(s), l == this || l._isChildOf(this))
                            {
                                ;
                            }
                            else
            ...
            }, n.prototype.onEvent = function (e)
            {
                ...
                if (o == s.tdExpand && !a || o == s.tdField || o == s.tdSeparator)
                {
                    switch (n)
                    {
                        case"click":
            ...
            }, n.prototype.onKeyDown = function (e)
            {
                ...
                if (13 == d)
                {
                    if (h == this.dom.value)
                    {
                        (!this.editable.value || e.ctrlKey) && i.isUrl(this.value) && (window.open(this.value, "_blank"), p = !0);
                    }
                    else if (h == this.dom.expand)
                    {
                ...
                {
                    l && f && (this._onDuplicate(), p = !0);
                }
                else if (69 == d)
                {
                    l && (this._onExpand(c), h.focus(), p = !0);
                }
                else if (77 == d && f)
                {
                    l && (this.showContextMenu(h), p = !0);
                }
                else if (46 == d && f)
                {
                    l && (this._onRemove(), p = !0);
                }
                else if (45 == d && f)
                {
                    l && !c ? (this._onInsertBefore(), p = !0) : l && c && (this._onInsertAfter(), p = !0);
                }
                else if (35 == d)
                {
                    if (u)
                ...
                {
                    u && !c ? (t = this._previousNode(), t && t.focus(n.focusElement || this._getElementName(h)), p = !0) : u && c && (t = this._previousNode(), t && t.parent && (t.parent.moveBefore(this, t), this.focus(n.focusElement || this._getElementName(h))), p = !0);
                }
                else if (39 == d)
                {
                    if (u && !c)
                ...
                else if (40 == d)
                {
                    if (u && !c)
                    {
                        s = this._nextNode(), s && s.focus(n.focusElement || this._getElementName(h)), p = !0;
                    }
                    else if (u && c && f)
                    {
            ...
            }, n.prototype._previousNode = function ()
            {
                ...
                if (t && t.parentNode)
                {
                    var i = t;
                    do {
                        i = i.previousSibling, e = n.getNodeFromTarget(i);
                    }
                    while (i && e instanceof o && !e.isVisible())
                }
                return e
            }, n.prototype._nextNode = function ()
            {
                ...
                if (t && t.parentNode)
                {
                    var i = t;
                    do {
                        i = i.nextSibling, e = n.getNodeFromTarget(i);
                    }
                    while (i && e instanceof o && !e.isVisible())
                }
                return e
            ...
            }, n.prototype.showContextMenu = function (t, i)
            {
                var o = this, s = n.TYPE_TITLES, r = [];
                if (this.editable.value && r.push({
                        text: "Type", title: "Change the type of this field", className: "type-" + this.type, submenu: [
                            {
                    ...
                    }), this._hasChilds())
                {
                    ...
                    r.push({
                        text: "Sort", title: "Sort the childs of this " + this.type, className: "sort-" + a, click: function ()
                        {
                            o._onSort(a)
                        }, submenu: [
                            {
                ...
                if (this.parent && this.parent._hasChilds())
                {
                    ...
                    o == d[d.length - 1] && r.push({
                        text: "Append", title: "Append a new field with type 'auto' after this field (Ctrl+Shift+Ins)", submenuTitle: "Select the type of the field to be appended", className: "append", click: function ()
                        {
                            o._onAppend("", "", "auto")
                        }, submenu: [
                            {
                        ...
                        text: "Insert", title: "Insert a new field with type 'auto' before this field (Ctrl+Ins)", submenuTitle: "Select the type of the field to be inserted", className: "insert", click: function ()
                        {
    ...
    }, function (e, t, i)
    {
        ...
        n = [i(3)], o = function (e)
        {
                ...
                function i(e, t, o)
                {
                    o.forEach(function (o)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                d.innerHTML = '<div class="icon"></div>' + o.text;
                            }
                            t.push(r)
                        }
                    })
            ...
            }, t.prototype.hide = function ()
            {
                ...
                {
                    if (this.eventListeners.hasOwnProperty(i))
                    {
