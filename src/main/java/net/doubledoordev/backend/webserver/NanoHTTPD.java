...
public abstract class NanoHTTPD
{
    ...
    public static SSLServerSocketFactory makeSSLSocketFactory(String keyAndTrustStoreClasspathPath, char[] passphrase) throws IOException
    {
        ...
        try
        {
            ...
            InputStream keystoreStream = new FileInputStream(new File(Constants.ROOT, keyAndTrustStoreClasspathPath));
    ...
    public class HTTPSession
    {
        ...
        public void execute() throws IOException
        {
            try
            {
                ...
                ACCESS_LOG.debug(String.format("[%s] %s request to %s with data %s. %d response, data type: %s.", getHeaders().get("http-client-ip"), method.name(), getUri(), getQueryParameterString(), r.status.getRequestStatus(), r.getMimeType()));
            }
