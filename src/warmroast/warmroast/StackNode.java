...
public class StackNode implements Comparable<StackNode>
{
    ...
    private void log(StackTraceElement[] elements, int skip, long time)
    {
        ...
        getChild(bottom.getClassName(), bottom.getMethodName()).log(elements, skip + 1, time);
    }
    ...
    private void writeHtml(StringBuilder builder, McpMapping mapping, long totalTime)
    {
        ...
        builder.append("<span class=\"bar-inner\" style=\"width:").append(formatCssPct(getTotalTime() / (double) totalTime)).append("\">");
        builder.append("</span>");
        builder.append("</span>");
        builder.append("</div>");
